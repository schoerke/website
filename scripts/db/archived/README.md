...
**Single Source of Truth:** WordPress XML files are the authoritative source for all data. Instead of maintaining
separate seed/restore scripts, we use WordPress migration scripts directly.
