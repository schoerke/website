    ...
    <div className="space-y-8">
      ...
      <div className="divide-y divide-gray-200">
        {Array.from({ length: count }, (_, i) => (
          <article key={i} className="grid grid-cols-1 gap-4 py-6 first:pt-0">
            {/* Content column */}
            <div className="flex gap-4 sm:gap-6">
              {/* Image skeleton - always on the left */}
              <Skeleton className="h-20 w-20 flex-shrink-0 sm:h-28 sm:w-28" />
